...
Current release: **v2.6.2 — Developer Experience & Module Decomposition**
...
decomposed the largest modules into a feature-folder tree and initialized Git).
...
| **B. Portable single-file release** | one self-contained HTML file, identical in behavior to earlier releases | `dist/tam-intelligence-os-v2.6.2.html` |
...
Regenerate `dist/tam-intelligence-os-v2.6.2.html` from the modular source:
...
The verifier (63 checks) fails the build if:
