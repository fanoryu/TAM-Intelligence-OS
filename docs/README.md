...
| Milestone closure records | [`ECR/`](ECR/README.md) | Milestone Closure Records (`ECR-NNN`) — the final historical record of a closed milestone. **Milestone Epsilon: [ECR-001](ECR/ECR-001-milestone-epsilon-closure-record.md)** (Repository Adoption, closed at `0ad8150`) |
