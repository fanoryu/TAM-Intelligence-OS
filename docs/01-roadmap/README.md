...
| [UX-005-Executive-Personal-Workspace-Architecture.md](UX-005-Executive-Personal-Workspace-Architecture.md) | UX-005/UX-006 product architecture freeze: Executive vs Personal Workspace model, KPI ownership, data-grid & Action Center contracts, and the UX-005A–F / UX-006A–E sequence. UX-005A & UX-005B implemented |
| [MAINT-001-repository-maintenance.md](MAINT-001-repository-maintenance.md) | Repository maintenance & branding refresh: legacy-script removal, documentation sync, `assets/branding/` structure, and README refresh — the recommended next work item (not started) |
