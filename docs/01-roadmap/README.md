...
| [UX-005-Executive-Personal-Workspace-Architecture.md](UX-005-Executive-Personal-Workspace-Architecture.md) | UX-005/UX-006 product architecture freeze: Executive vs Personal Workspace model, KPI ownership, data-grid & Action Center contracts, and the UX-005A–F / UX-006A–E sequence. UX-005A/B/C merged; UX-005D (Global Search) is an implementation candidate; C–F resequenced (C=Design System, D=Global Search) |
