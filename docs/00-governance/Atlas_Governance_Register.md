...
| [RDR-007](../RDR/RDR-007-delta-repository-snapshot.md) | Delta Repository Snapshot (post-PR-8B) | `docs/RDR/` | Accepted (superseded as baseline by RDR-011) (`55499f2`) |
| [RDR-011](../RDR/RDR-011-epsilon-repository-snapshot.md) | Epsilon Repository Snapshot — Aggregate-Backed Repository Adoption Complete | `docs/RDR/` | **Accepted — current authoritative baseline** (`6714beb`) |
...
repository snapshots are **superseded** by the current baselines ([RDR-011](../RDR/RDR-011-epsilon-repository-snapshot.md),
[DPR-009](../DPR/DPR-009-epsilon-repository-adoption-completion.md)); reviews/approvals are recorded as milestone events.
...
| RDR-008 / RDR-009 | Intermediate Epsilon repository snapshots | Record-only — **superseded by [RDR-011](../RDR/RDR-011-epsilon-repository-snapshot.md)** |
| DPR-006 / DPR-007 | Intermediate Epsilon progress reports | Record-only — **superseded by [DPR-009](../DPR/DPR-009-epsilon-repository-adoption-completion.md)** |
...
| RDR-010 | Contract-adoption-complete repository snapshot | Record-only — **superseded by [RDR-011](../RDR/RDR-011-epsilon-repository-snapshot.md)** |
| DPR-008 | Epsilon Progress Report — Contract Adoption Complete | Record-only — **superseded by [DPR-009](../DPR/DPR-009-epsilon-repository-adoption-completion.md)** |
